...
const ClapComponent = ({
  ...
  const [currentClapCount, setCurrentClapCount] = useState<number>(clapCount);
  const [currentUserClapCount, setCurrentUserClapCount] =
    useState<number>(userClapCount);
  ...
  return (
    ...
    >
      ...
      <p className="text-sm opacity-60">{currentClapCount}</p>
    </button>
  );
};
